...
const en = {
  ...
  clearDataBody: 'All sessions, work blocks, categories, and rate history will be permanently deleted. Preferences like theme, language, and week settings are kept.',
  clearDataAction: 'Delete everything',
  rateHistory: 'Rate history', addRateChange: 'Add rate change',
  payPeriod: 'Pay period', payPeriodHint: 'Groups hours and earnings into paycheck-sized periods.',
  categories: 'Categories', addCategory: 'Add category', categoryPlaceholderAdd: 'New category name',
  rename: 'Rename', noCategories: 'No categories yet — add the kinds of work you do.',
  categoryExists: 'That category already exists.', removeCategoryConfirm: 'Remove category?',
  removeCategoryBody: '{name} will be removed from your list. Sessions keep their hours and earnings but become uncategorised.',
  payPeriodNone: 'None', payWeekly: 'Weekly', payBiweekly: 'Every 2 weeks',
  firstPeriodStartedOn: 'First period started on',
  thisPayPeriod: 'This period', currentPeriod: 'Current period',
  earningsByPeriod: 'Earnings by pay period',
  ...
  session: 'Session', newSession: 'New session', addSession: 'Add session',
  ...
  workCategoriesQ: 'What kinds of work do you do? (optional)',
...
const bn: Record<StringKey, string> = {
  ...
  earningsByCategory: 'ক্যাটাগরি অনুযায়ী আয়',
  vs: 'বনাম', allTime: 'সর্বকালীন', sessions: 'সেশন', hours: 'ঘণ্টা',
  clearData: 'সব ডেটা মুছুন',
  clearDataConfirm: 'সব ডেটা মুছে ফেলবেন?',
  clearDataBody: 'সব সেশন, ওয়ার্ক ব্লক, ক্যাটাগরি এবং রেটের ইতিহাস চিরতরে মুছে যাবে। থিম, ভাষা, সপ্তাহের সেটিংসের মতো পছন্দগুলো থেকে যাবে।',
  clearDataAction: 'সব মুছে ফেলুন',
  rateHistory: 'রেটের ইতিহাস', addRateChange: 'রেট পরিবর্তন যোগ করুন',
  payPeriod: 'বেতন-পিরিয়ড', payPeriodHint: 'ঘণ্টা ও আয় বেতন-পিরিয়ড অনুযায়ী দেখায়।',
  categories: 'ক্যাটাগরি', addCategory: 'ক্যাটাগরি যোগ করুন', categoryPlaceholderAdd: 'নতুন ক্যাটাগরির নাম',
  rename: 'নাম বদলান', noCategories: 'এখনো ক্যাটাগরি নেই — আপনার কাজের ধরনগুলো যোগ করুন।',
  categoryExists: 'এই ক্যাটাগরি আগেই আছে।', removeCategoryConfirm: 'ক্যাটাগরি মুছে ফেলবেন?',
  removeCategoryBody: '{name} আপনার তালিকা থেকে মুছে যাবে। সেশনগুলোর ঘণ্টা ও আয় থেকে যাবে, শুধু ক্যাটাগরিহীন হবে।',
  payPeriodNone: 'নেই', payWeekly: 'সাপ্তাহিক', payBiweekly: 'প্রতি ২ সপ্তাহে',
  firstPeriodStartedOn: 'প্রথম পিরিয়ড শুরু হয়েছিল',
  thisPayPeriod: 'এই পিরিয়ড', currentPeriod: 'চলতি পিরিয়ড',
  earningsByPeriod: 'বেতন-পিরিয়ড অনুযায়ী আয়',
  ...
  session: 'সেশন', newSession: 'নতুন সেশন', addSession: 'সেশন যোগ করুন',
  checkInLabel: 'চেক ইন', checkOutLabel: 'চেক আউট',
  ...
  workCategoriesQ: 'আপনি কী ধরনের কাজ করেন? (ঐচ্ছিক)',

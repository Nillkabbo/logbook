...
const en = {
  ...
  clearDataBody: 'All sessions, work blocks, and rate history will be permanently deleted. Preferences like theme, language, and week settings are kept.',
  ...
  rateHint: 'Effective today — past sessions keep the rate they were worked at. Empty clears all rates.',
  ...
  errRatePositive: 'Enter a rate greater than zero.',
...
const bn: Record<StringKey, string> = {
  ...
  clearDataBody: 'সব সেশন, ওয়ার্ক ব্লক এবং রেটের ইতিহাস চিরতরে মুছে যাবে। থিম, ভাষা, সপ্তাহের সেটিংসের মতো পছন্দগুলো থেকে যাবে।',
  ...
  rateHint: 'আজ থেকে কার্যকর — পুরনো সেশনগুলো নিজ নিজ রেটেই থাকবে। খালি করলে সব রেট মুছে যাবে।',
  ...
  errRatePositive: 'শূন্যের বেশি একটি হার লিখুন।',
